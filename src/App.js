  ...
  return (
    <div className="App">
      <HashRouter basename='/'>
        ...
        <div className="footer">Made with ❤ by <a className="developer" href="https://twitter.com/xsmndr">acesmndr</a><a className="developer-card" href="https://about.me/acesmndr"><img className="ace-of-spades" src={require('./aces.jpeg')} alt="card" /></a></div>
        <ReactTooltip />
      </HashRouter>
    </div>
  );
